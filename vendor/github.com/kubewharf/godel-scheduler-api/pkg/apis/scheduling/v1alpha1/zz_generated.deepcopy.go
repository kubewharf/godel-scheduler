...
func (in *MovementStatus) DeepCopyInto(out *MovementStatus) {
	*out = *in
	if in.OwnerMovements != nil {
		in, out := &in.OwnerMovements, &out.OwnerMovements
		*out = make([]*OwnerMovement, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(OwnerMovement)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeSuggestion) DeepCopyInto(out *NodeSuggestion) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeSuggestion.
func (in *NodeSuggestion) DeepCopy() *NodeSuggestion {
	if in == nil {
		return nil
	}
	out := new(NodeSuggestion)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OwnerMovement) DeepCopyInto(out *OwnerMovement) {
	*out = *in
	if in.Owner != nil {
	...
	if in.NodeSuggestions != nil {
		...
		*out = make([]*NodeSuggestion, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NodeSuggestion)
	...
	if in.TasksBreakSuggestion != nil {
		in, out := &in.TasksBreakSuggestion, &out.TasksBreakSuggestion
		*out = make([]*TaskInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OwnerMovement.
func (in *OwnerMovement) DeepCopy() *OwnerMovement {
	if in == nil {
		return nil
	}
	out := new(OwnerMovement)
