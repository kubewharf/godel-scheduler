...
import (
	v1alpha1 "github.com/kubewharf/godel-scheduler-api/pkg/client/clientset/versioned/typed/scheduling/v1alpha1"
...
func (c *FakeSchedulingV1alpha1) Movements() v1alpha1.MovementInterface {
	return &FakeMovements{c}
}
