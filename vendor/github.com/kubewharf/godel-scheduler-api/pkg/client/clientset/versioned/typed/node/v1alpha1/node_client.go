...
import (
	...
	"github.com/kubewharf/godel-scheduler-api/pkg/client/clientset/versioned/scheme"
...
// NodeV1alpha1Client is used to interact with features provided by the node.godel.kubewharf.io group.
type NodeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NodeV1alpha1Client) NMNodes() NMNodeInterface {
	return newNMNodes(c)
}
