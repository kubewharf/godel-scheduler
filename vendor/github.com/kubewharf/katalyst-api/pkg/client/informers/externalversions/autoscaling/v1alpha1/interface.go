...
type Interface interface {
	...
	// VerticalPodAutoscalerRecommendations returns a VerticalPodAutoscalerRecommendationInformer.
	VerticalPodAutoscalerRecommendations() VerticalPodAutoscalerRecommendationInformer
}
...
// VerticalPodAutoscalerRecommendations returns a VerticalPodAutoscalerRecommendationInformer.
func (v *version) VerticalPodAutoscalerRecommendations() VerticalPodAutoscalerRecommendationInformer {
	return &verticalPodAutoscalerRecommendationInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
