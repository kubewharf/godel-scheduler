...
func (rc *RCConfig) RCConfigLog(format string, args ...interface{}) {
	if rc.LogFunc != nil {
		rc.LogFunc(format, args...)
	}
...
func (config *DeploymentConfig) GetKind() schema.GroupKind {
	return Kind(apps.SchemeGroupVersion, "Deployment")
}
...
func (config *DeploymentConfig) GetGroupVersionResource() schema.GroupVersionResource {
	return apps.SchemeGroupVersion.WithResource("deployments")
}
...
func (config *ReplicaSetConfig) GetKind() schema.GroupKind {
	return Kind(apps.SchemeGroupVersion, "ReplicaSet")
}
...
func (config *ReplicaSetConfig) GetGroupVersionResource() schema.GroupVersionResource {
	return apps.SchemeGroupVersion.WithResource("replicasets")
}
...
func (config *RCConfig) GetKind() schema.GroupKind {
	return Kind(apps.SchemeGroupVersion, "ReplicationController")
}
...
func (config *SecretConfig) Stop() error {
	if err := DeleteResourceWithRetries(config.Client, Kind(v1.SchemeGroupVersion, "Secret"), config.Namespace, config.Name, metav1.DeleteOptions{}); err != nil {
...
func (config *ConfigMapConfig) Stop() error {
	if err := DeleteResourceWithRetries(config.Client, Kind(v1.SchemeGroupVersion, "ConfigMap"), config.Namespace, config.Name, metav1.DeleteOptions{}); err != nil {
